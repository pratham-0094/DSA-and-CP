...
// simmilar to bin sort but here we have to take an array of size 10 as the number we insert is interger number and decial system contain 0 - 9 digit initialize the list with NULL this means they are pointers
// if the number are in binary form then we have to need only 2 bins
// time complexity = O(n)
